...
func (x *WalletLogResponse) GetEntity() *WalletLog {
	if x != nil {
		return x.Entity
	}
	return nil
...
func (x *WalletLogResponse) GetPager() *common.Pager {
	if x != nil {
		return x.Pager
	}
	return nil
...
func (x *WalletLogResponse) GetItems() []*WalletLog {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *WalletLogResponse) GetInfo() string {
	if x != nil {
		return x.Info
	}
	return ""
...
var file_walletLogService_proto_rawDesc = []byte{
	...
	0x65, 0x79, 0x22, 0xa4, 0x01, 0x0a, 0x11, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x4c, 0x6f, 0x67,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x32, 0x92, 0x01, 0x0a, 0x10, 0x57, 0x61,
	0x6c, 0x6c, 0x65, 0x74, 0x4c, 0x6f, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x39,
	0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x13, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
	0x2e, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x4c, 0x6f, 0x67, 0x1a, 0x1b, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x4c, 0x6f, 0x67, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x43, 0x0a, 0x06, 0x53, 0x65, 0x61,
	0x72, 0x63, 0x68, 0x12, 0x1a, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x57,
	...
	0x74, 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0d,
...
var file_walletLogService_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_walletLogService_proto_goTypes = []interface{}{
	...
	(*WalletLogResponse)(nil), // 2: services.WalletLogResponse
	(*MemberInfo)(nil),        // 3: services.MemberInfo
	(*Wallet)(nil),            // 4: services.Wallet
	(*common.Pager)(nil),      // 5: common.Pager
}
var file_walletLogService_proto_depIdxs = []int32{
	3, // 0: services.WalletLog.member:type_name -> services.MemberInfo
	4, // 1: services.WalletLog.wallet:type_name -> services.Wallet
	0, // 2: services.WalletLogResponse.entity:type_name -> services.WalletLog
	5, // 3: services.WalletLogResponse.pager:type_name -> common.Pager
	0, // 4: services.WalletLogResponse.items:type_name -> services.WalletLog
	0, // 5: services.WalletLogService.Get:input_type -> services.WalletLog
	1, // 6: services.WalletLogService.Search:input_type -> services.WalletLogRequest
	2, // 7: services.WalletLogService.Get:output_type -> services.WalletLogResponse
	2, // 8: services.WalletLogService.Search:output_type -> services.WalletLogResponse
