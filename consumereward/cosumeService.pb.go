...
func (x *Consume) GetBeginDate() int64 {
	if x != nil {
		return x.BeginDate
	}
	return 0
...
func (x *Consume) GetEndDate() int64 {
	if x != nil {
		return x.EndDate
	}
	return 0
...
func (x *Consume) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *Consume) GetUpdatedAt() int64 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
var file_cosumeService_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x62, 0x65, 0x67, 0x69,
	...
	0x16, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74,
