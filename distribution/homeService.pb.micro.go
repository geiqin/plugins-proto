...
type HomeService interface {
	...
	//分销介绍
	Introduce(ctx context.Context, in *HomeRequest, opts ...client.CallOption) (*HomeResponse, error)
}
...
func (c *homeService) Introduce(ctx context.Context, in *HomeRequest, opts ...client.CallOption) (*HomeResponse, error) {
...
type HomeServiceHandler interface {
	...
	//分销介绍
	Introduce(context.Context, *HomeRequest, *HomeResponse) error
}
...
func RegisterHomeServiceHandler(s server.Server, hdlr HomeServiceHandler, opts ...server.HandlerOption) error {
	type homeService interface {
		...
		Introduce(ctx context.Context, in *HomeRequest, out *HomeResponse) error
	}
	type HomeService struct {
		homeService
	}
...
func (h *homeServiceHandler) Introduce(ctx context.Context, in *HomeRequest, out *HomeResponse) error {
