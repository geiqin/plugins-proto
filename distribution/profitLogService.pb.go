...
type ProfitLogResponse struct {
	...
	Data  *ProfitLogData `protobuf:"bytes,1,opt,name=data,proto3" json:"data"`
...
var file_profitLogService_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x03, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0xae, 0x01, 0x0a, 0x0d, 0x50, 0x72,
	0x6f, 0x66, 0x69, 0x74, 0x4c, 0x6f, 0x67, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2b, 0x0a, 0x06, 0x65,
	...
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x74, 0x4c, 0x6f,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x65, 0x0a, 0x11, 0x50, 0x72,
	...
	,
...
var file_profitLogService_proto_depIdxs = []int32{
	4, // 0: services.ProfitLog.member:type_name -> services.MemberInfo
	0, // 1: services.ProfitLogData.entity:type_name -> services.ProfitLog
	5, // 2: services.ProfitLogData.pager:type_name -> common.Pager
	0, // 3: services.ProfitLogData.items:type_name -> services.ProfitLog
	6, // 4: services.ProfitLogData.info:type_name -> common.Info
	2, // 5: services.ProfitLogResponse.data:type_name -> services.ProfitLogData
	7, // 6: services.ProfitLogResponse.error:type_name -> common.Error
	0, // 7: services.ProfitLogService.Detail:input_type -> services.ProfitLog
	1, // 8: services.ProfitLogService.Search:input_type -> services.ProfitLogRequest
	3, // 9: services.ProfitLogService.Detail:output_type -> services.ProfitLogResponse
	3, // 10: services.ProfitLogService.Search:output_type -> services.ProfitLogResponse
