...
type MemberCoupon struct {
	...
	StartTime    int64       `protobuf:"varint,5,opt,name=start_time,json=startTime,proto3" json:"start_time"`                 //开始时间
	EndTime      int64       `protobuf:"varint,6,opt,name=end_time,json=endTime,proto3" json:"end_time"`                       //结束时间
	...
	UsedTime     int64       `protobuf:"varint,10,opt,name=used_time,json=usedTime,proto3" json:"used_time"`                   //使用时间
...
func (x *MemberCoupon) GetStartTime() int64 {
	if x != nil {
		return x.StartTime
	}
	return 0
...
func (x *MemberCoupon) GetEndTime() int64 {
	if x != nil {
		return x.EndTime
	}
	return 0
...
func (x *MemberCoupon) GetUsedTime() int64 {
	if x != nil {
		return x.UsedTime
	}
	return 0
...
func (x *MemberCoupon) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *MemberCoupon) GetUpdatedAt() int64 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
var file_memberCouponService_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x75, 0x73, 0x65, 0x64,
