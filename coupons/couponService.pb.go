...
type Coupon struct {
	...
	ExpireStartTime   int64       `protobuf:"varint,15,opt,name=expire_start_time,json=expireStartTime,proto3" json:"expire_start_time"`       //生效时间
	ExpireEndTime     int64       `protobuf:"varint,16,opt,name=expire_end_time,json=expireEndTime,proto3" json:"expire_end_time"`             //到期时间
	...
	CreatedAt         int64       `protobuf:"varint,29,opt,name=created_at,json=createdAt,proto3" json:"created_at"`                           //创建时间
	UpdatedAt         int64       `protobuf:"varint,30,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at"`                           //修改时间
...
func (x *Coupon) GetExpireStartTime() int64 {
	if x != nil {
...
func (x *Coupon) GetExpireEndTime() int64 {
	if x != nil {
...
var file_couponService_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x0f, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x53, 0x74, 0x61, 0x72, 0x74,
	0x54, 0x69, 0x6d, 0x65, 0x12, 0x26, 0x0a, 0x0f, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x5f, 0x65,
	0x6e, 0x64, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x10, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x65,
	...
	0x61, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x1d, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x63,
