...
type CalculateService interface {
	Handle(ctx context.Context, in *CalculateRequest, opts ...client.CallOption) (*CalculateResponse, error)
}
...
func (c *calculateService) Handle(ctx context.Context, in *CalculateRequest, opts ...client.CallOption) (*CalculateResponse, error) {
	req := c.c.NewRequest(c.name, "CalculateService.Handle", in)
...
type CalculateServiceHandler interface {
	Handle(context.Context, *CalculateRequest, *CalculateResponse) error
}

func RegisterCalculateServiceHandler(s server.Server, hdlr CalculateServiceHandler, opts ...server.HandlerOption) error {
	type calculateService interface {
		Handle(ctx context.Context, in *CalculateRequest, out *CalculateResponse) error
	}
	type CalculateService struct {
		calculateService
	}
...
func (h *calculateServiceHandler) Handle(ctx context.Context, in *CalculateRequest, out *CalculateResponse) error {
	return h.CalculateServiceHandler.Handle(ctx, in, out)
}
